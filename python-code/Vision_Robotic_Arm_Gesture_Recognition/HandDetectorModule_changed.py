...
class HandDetector():
    ...
    def open_or_close_distance_dif(self, frame=None, draw=True, min_distance_difference=S.dynamic_grab_distance_difference, time_difference=S.dynamic_grab_time_difference):
